...
class AddEditNoteActivity : AppCompatActivity() {
    companion object {
        const val EXTRA_ID = "com.example.latihancatatanku.EXTRA_ID"
        const val EXTRA_JUDUL = "com.example.latihancatatanku.EXTRA_JUDUL"
        const val EXTRA_DESKRIPSI = "com.example.latihancatatanku.EXTRA_DESKRIPSI"
        const val EXTRA_PRIORITAS = "com.example.latihancatatanku.EXTRA_PRIORITAS"
